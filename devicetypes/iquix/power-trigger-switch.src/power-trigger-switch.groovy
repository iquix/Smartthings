...
metadata {
	definition (name: "Power Trigger Switch", namespace: "iquix", author: "iquix", mnmn: "SmartThingsCommunity", vid: "20db7582-cf21-33d2-a3e7-9a16e12d9426", ocfDeviceType: "oic.d.switch") { 
        ...
        // Delete the line below(only line 29, / * ) of the soruce code to pair with Dawon Plugs/Outlets. Restore the line below (= comment out the fingerprints) to pair Dawon Plugs/Outlets with default Edge Driver
		/*
